    ...
    function (AppComponent) {
        ...
        return AppComponent.extend("vendormanagementapp.Component", {
            ...
            _wireChartHandlers: function (oFilterBar) {
                ...
                if (oSettingsBtn) {
                    var aTilesConfig = [
                        { id: sFragId + "--kpiTileRiskAmount", label: "Montant à Risque (€)", checked: true  },
                        { id: sFragId + "--kpiTileActive",     label: "Fournisseurs actifs",   checked: false },
                        { id: sFragId + "--kpiTileInactive",   label: "Inactifs (> 12 mois)",  checked: false }
                    ];
                    var oPopover = null;
                    ...
                    oRiskChart.attachSelectionChanged(function (oEvent) {
                        ...
                        if (aBars && aBars.length) {
                            sap.ui.require(["sap/m/MessageToast"], function (T) {
                                T.show("Filtrez «\u00a0Statut de risque\u00a0» = " + aBars[0].getLabel() + " via la barre de filtres");
                            });
                        }
                    });
                }
                ...
                if (oInactChart && typeof oInactChart.attachSelectionChanged === "function") {
                    oInactChart.attachSelectionChanged(function (oEvent) {
                        ...
                        if (aBars && aBars.length) {
                            sap.ui.require(["sap/m/MessageToast"], function (T) {
                                T.show("Filtrez «\u00a0Inactivité\u00a0» = " + aBars[0].getLabel() + " via la barre de filtres");
                            });
                        }
                    });
                }
